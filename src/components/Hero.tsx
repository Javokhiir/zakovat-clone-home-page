            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Zakovat klubi — bilimdon yoshlar uchun intellektual hamjamiyat. Bu yerda siz
                  aqlni charxlovchi savollar, jamoaviy musobaqalar va bilimli do‘stlar bilan
                  tanishasiz.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600">Tanlovlar</div>
                </div>
                <div className="text-center">
              ...
              <div className="bg-gradient-to-tr from-blue-500 to-purple-600 rounded-2xl p-8 text-white">
                <div className="space-y-6">
                  <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
                    <h3 className="text-xl font-semibold mb-2">Intellektual O‘yinlar</h3>
                    <p className="text-blue-100">Savollar orqali bilim va mantiqni sinang</p>
                  </div>
                  <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
                    <h3 className="text-xl font-semibold mb-2">Mentorlar Bilan</h3>
                    <p className="text-blue-100">Tajribali a'zolar yordamida rivojlaning</p>
                  </div>
                  <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
                    <h3 className="text-xl font-semibold mb-2">Jamoaviy Faoliyat</h3>
                    <p className="text-blue-100">Birgalikda o‘rganish va g‘alaba sari yurish</p>
                  </div>
                </div>
              </div>
            </div>
